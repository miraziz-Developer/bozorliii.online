# Do'kon egasi bilan gaplashish uchun — qisqa qo'llanma

Bu `MERCHANT_PITCH.md`ning to'liq versiyasi emas — bozorga borib, do'konchi bilan 2-3 daqiqada gaplashish uchun tayyorlangan. To'liq hujjatni (yoki `MERCHANT_PITCH_UZ.html`ni telefoningizdan) keyin ko'rsatasiz, bu — og'zaki boshlash uchun.
...
Ko'pchilik "yo'q" yoki "kam" deydi — shu yerda o'tish qiling.
...
- Telefon/planshet — `bozorliii.online`ni ochib, real ilovani ko'rsatish uchun (endi Android APK ham bor — o'rnatib ko'rsatsangiz ta'sirchan bo'ladi)
- Agar bosma material kerak bo'lsa — `docs/MERCHANT_PITCH_UZ.html`ni PDF qilib chiqarib berish mumkin (so'rasangiz tayyorlab beraman)

## Rozi bo'lgandan keyin — darhol qiling (kutmang)

1. O'sha yerda telefonida Telegram botni oching: `@Bozorliiicrm_bot` → `/start`
2. Kamida 1 ta mahsulot rasmini shu yerda oling va yuboring — "keyin qilaman" degan odam ko'pincha qilmaydi
3. Telefon raqamini oling, o'zingiz ham CRM orqali kuzatib boring
